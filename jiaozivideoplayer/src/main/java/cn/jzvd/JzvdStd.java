...
//                mute_btn.setVisibility(VISIBLE);
    ...
    public void setBannerImg(HomeBannerBean homeBannerBean,OnClickListener onClickListener) {
        bannerImageView.setVisibility(VISIBLE);
        GlideUtils
                .getInstance()
                .LoadNewContextBitmap(mContext,
                        homeBannerBean.getPicUrl(),
                        bannerImageView,
                        0,
                        0,
                        GlideUtils.LOAD_BITMAP);
        bannerImageView.setOnClickListener(onClickListener);
    }
